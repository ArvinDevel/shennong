...
public class PartsuppDeserializer<T extends SpecificRecordBase> implements Deserializer<T> {
    ...
    public T deserialize(String topic, byte[] data) {
        try {
            DatumReader<T> userDatumReader = new SpecificDatumReader<>(Partsupp.getClassSchema());
