...
public class OrdersDeserializer<T extends SpecificRecordBase> implements Deserializer<T> {
    ...
    public T deserialize(String topic, byte[] data) {
        try {
            DatumReader<T> userDatumReader = new SpecificDatumReader<>(Orders.getClassSchema());
