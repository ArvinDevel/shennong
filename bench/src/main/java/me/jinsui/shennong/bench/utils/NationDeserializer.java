...
import me.jinsui.shennong.bench.avro.Nation;
...
public class NationDeserializer<T extends SpecificRecordBase> implements Deserializer<T> {
    ...
    public T deserialize(String topic, byte[] data) {
        try {
            DatumReader<T> userDatumReader = new SpecificDatumReader<>(Nation.getClassSchema());
